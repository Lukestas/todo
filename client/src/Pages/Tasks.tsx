import React, { useId } from 'react'; // react hook useId Import
import useTask from '../hooks/useTask'; // useTask custom hook import
import Pagination from '../components/Pagination/Pagination'; // Pagination component import
import TaskList from '../components/TaskList/TaskList'; // TaskList component import
import DeleteAllCompletedTasks from '../components/DeleteAllCompletedTasks/DeleteAllCompletedTasks'; // DeleteAllCompletedTasks component import
